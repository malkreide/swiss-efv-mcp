"""swiss-efv-mcp — MCP server for Swiss federal finances (EFV)."""
...
try:
    ...
    # drift apart: pyproject said 0.3.0, this said 0.1.0. A value nobody
    # has to remember to bump cannot go stale.
    __version__ = _distribution_version("swiss-efv-mcp")
